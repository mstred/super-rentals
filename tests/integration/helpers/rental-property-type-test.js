...
module('Integration | Helper | rental-property-type', function(hooks) {
  ...
  test('it renders correctly for a Standalone rental property', async function(assert) {
  ...
  test('it renders correctly for a Community rental property', async function(assert) {
